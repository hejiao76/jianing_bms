...
define([],function (){
    return [
        ...
        '<label class="">文章类型</label>',
            ...
            '<select id="newsTypeSelect" class="col-sm-5 choice_num ">',
            '<option value="1">装修知识</option>',
            '<option value="2">装修事故</option>',
            // '<option value="3">选项三</option>',
            '</select>',
            // '<input id="newsAuthor" class="col-sm-5 fleft" type="text">',
            '<span class="col-sm-1 fleft inlineB" style="height: 46px;"></span>',
            '<label class="">作者名称</label>',
            '<input id="newsAuthor" class="col-sm-4 fleft" type="text">',
            // '<select id="newsTypeSelect" class="col-sm-5 choice_num ">',
