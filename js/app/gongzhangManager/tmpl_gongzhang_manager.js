...
define([],function (){
    return [
        ...
        '</div>',
        '<table id="gongzhang_list_table" class="module_tabel">',
        '<thead>',
        '<tr>',
        ...
        '</tr>',
        '<thead>',
        '<tbody id="gongzhang_list_table_tbody">',
        // '<tr>',
            ...
            '<div class="modal-dialog">',
                '<div class="modal-content">',
                    ...
                    '<div class="modal-body pop_content">',
                        '<p class="font14 mb20 tl"><span style="color:red;">*</span>gongzhang图</p><img id="gongzhangImgPreview" class="cp"  style="max-width:300px;display: none;" src="http://192.168.1.133:8888/img/2017/20170106092437.jpg">',
                        '<input id="gongzhangFileInput" name="file" class="input01" type="file">',
                        '<input id="gongzhangUrl" class="input01 hide">',
