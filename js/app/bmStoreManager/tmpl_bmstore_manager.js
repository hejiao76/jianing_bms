...
define([],function (){
    return [
        ...
        '<button id="addNewsBtn" class="sort_tz fright mr15">新增材料</button>',
        '</div>',
        '<table id="bmstore_list_table" class="module_tabel">',
        '<thead>',
        '<tr>',
        ...
        '</tr>',
        '<thead>',
        '<tbody id="bmstore_list_table_tbody">',
        // '<tr>',
            ...
            '<div class="modal-dialog">',
                '<div class="modal-content">',
                    ...
                    '<div class="modal-body pop_content">',
                        '<p class="font14 mb20 tl"><span style="color:red;">*</span>news图</p><img id="bmstoreImgPreview" class="cp"  style="max-width:300px;display: none;" src="http://192.168.1.133:8888/img/2017/20170106092437.jpg">',
                        '<input id="bmstoreFileInput" name="file" class="input01" type="file">',
